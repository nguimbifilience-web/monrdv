...
<div class="p-8 max-w-4xl">
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-xs text-gray-400 font-bold uppercase tracking-widest">{{ $feuille->date->format('d/m/Y') }} - {{ $feuille->patient->nom }} {{ $feuille->patient->prenom }}</p>
        </div>
        <a href="{{ route('medecin.examens.print', $feuille) }}" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-2xl font-bold text-xs uppercase tracking-widest shadow-md shadow-blue-100">
