        ...
        <div class="p-10">
            ...
            <form action="{{ route('patients.store') }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Email (Optionnel)</label>
                        <div class="relative">
                ...
                <div class="flex gap-4">
                    <button type="submit" id="btnSubmit" class="bg-blue-600 hover:bg-blue-700 text-white font-black px-10 py-4 rounded-2xl shadow-lg transition-all uppercase tracking-widest text-xs">
