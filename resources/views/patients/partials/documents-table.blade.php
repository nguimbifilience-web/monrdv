        ...
        <tr class="hover:bg-gray-50/30 transition-colors">
            ...
            <td class="p-5">
                <div class="flex justify-center gap-2">
                    <a href="{{ route('patients.documents.view', [$patient, $doc]) }}" target="_blank"
                    ...
                    @if($peutSupprimer)
                    <form action="{{ route('patients.documents.destroy', [$patient, $doc]) }}" method="POST" onsubmit="return confirm('Supprimer ce document ?')">
                        @csrf @method('DELETE')
